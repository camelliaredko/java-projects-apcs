...
public class CO2FromWasteTester
{
   public static void main(String[] args)
   {
       ...
       cO2.add(new CO2FromWaste(2, true, true, false, true));    // add households to the arraylist
       cO2.add(new CO2FromWaste(10, true, true, true, true));
       cO2.add(new CO2FromWaste(1, false, true, false, false));
       cO2.add(new CO2FromWaste(4, false, false, true, false));
       cO2.add(new CO2FromWaste(5, true, true, false, false));
       cO2.add(new CO2FromWaste(10, false, false, false, false));
